...
/**
 * ADVERTENCIA DE SEGURIDAD: Esta implementación NO verifica la identidad
 * biométrica del hablante.
 * Solo verifica CONOCIMIENTO DE UNA FRASE (passphrase) mediante transcripción Vosk.
 *
 * CUALQUIER PERSONA QUE CONOZCA LA FRASE PUEDE SUMPLANTAR AL DUEÑO.
 * No usar como factor biométrico real (requireVoice=true) en entornos de alta seguridad.
 *
 * Para verificación de hablante real (speaker verification), implementar
 * EmbeddingVoiceAuthProvider con Resemblyzer/WeNet/Nemo/Picovoice Eagle.
 *
